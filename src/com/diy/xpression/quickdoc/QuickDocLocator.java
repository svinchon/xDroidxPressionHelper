...
public class QuickDocLocator extends org.apache.axis.client.Service implements com.diy.xpression.quickdoc.QuickDoc {
    ...
    private java.lang.String QuickDocHttpSoap11Endpoint_address = "http://xpressionhost:8080/xFramework/services/QuickDoc.QuickDocHttpSoap11Endpoint/";
    ...
    public com.diy.xpression.quickdoc.QuickDocPortType getQuickDocHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public com.diy.xpression.quickdoc.QuickDocPortType getQuickDocHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.diy.xpression.quickdoc.QuickDocSoap11BindingStub _stub = new com.diy.xpression.quickdoc.QuickDocSoap11BindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.diy.xpression.quickdoc.QuickDocPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.diy.xpression.quickdoc.QuickDocSoap11BindingStub _stub = new com.diy.xpression.quickdoc.QuickDocSoap11BindingStub(new java.net.URL(QuickDocHttpSoap11Endpoint_address), this);
                _stub.setPortName(getQuickDocHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
        }
